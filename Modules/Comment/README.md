...
```bash
php artisan vendor:publish --provider="Modules\Comment\CommentsServiceProvider" --tag="migrations"
```
...
```bash
php artisan vendor:publish --provider="Modules\Comment\CommentsServiceProvider" --tag="config"
```
