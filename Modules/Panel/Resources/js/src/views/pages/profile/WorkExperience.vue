  ...
  <vx-card no-shadow>
    ...
    <vs-row vs-type="flex"  vs-w="12">
        <vs-col vs-type="flex" vs-align="center" vs-lg="12">
            <vue-repeater v-model="form.work_experiences"></vue-repeater>
        </vs-col>
    </vs-row>
    <!-- Save & Reset Button -->
...
Vue.component("work-experience-item",WorkExperienceItem)
export default {
  ...
  async created() {
    ...
    if(this.userData.work_experiences){
        this.form.work_experiences=this.userData.work_experiences.map(item=>{
            return {
                name:'work-experience-item',
                value:item
            }
  ...
  methods:{
      ...
      async updateProfile(){
          ...
          form.work_experiences=form.work_experiences.map(experience=>{
