<template>
  <vx-card no-shadow>
    ...
    <div class="mt-8 mb-base">
      <label class="text-sm">{{__("Gender")}}</label>
      <div class="mt-2">
        <vs-radio v-model="gender" vs-value="male" class="mr-4">{{__("Male")}}</vs-radio>
        <vs-radio v-model="gender" vs-value="female" class="mr-4">{{__("Female")}}</vs-radio>
        <vs-radio v-model="gender" vs-value="other">{{__("Other")}}</vs-radio>
      </div>
    </div>

    <!-- Save & Reset Button -->
    <div class="flex flex-wrap items-center justify-end">
      <vs-button class="ml-auto mt-2">{{__("Save Changes")}}</vs-button>
