...
export default {
	...
	props: { name: { type: String, default: () => ("element") }, value: { type: String, default: () => ("") }, allCategoryText  : { type: String, default: () => __("From all categories") }, unCategorizedText: { type: String, default: () => __("Uncategorized") }, searchPlaceholder: { type: String, default: () => __("Search Icons") }, hasSearch: { type: Boolean, default: () => true } },
	computed: {
		icon: {
			set(icon=null){
				if(icon) {
