    ...
    <vx-card>
      ...
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
          ...
          />
          <vx-tooltip class="mx-1 larger-icon" :text="__('Create User')">
            <vs-button
              color="success"
              to="/users/create"
              type="filled"
  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: this.__('Password'),
          field: 'password',
          resizable: true,
        },
        {
          headerName: this.__('Remember Token'),
          field: 'remember_token',
          resizable: true,
        },
        {
          headerName: this.__('Gender'),
          field: 'gender',
          resizable: true,
        },
        {
        ...
        {
          headerName: this.__('دسترسی به زیرمجموعه ها'),
          field: 'master',
          resizable: true,
        },
        {
