    ...
    <vx-card>
      ...
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
          ...
          <vx-tooltip class="mx-1 larger-icon" :text="__('Create Activitylog')">
            <vs-button
              color="success"
              to="/user_activities/create"
              type="filled"
              icon="icon-plus"
              icon-pack="feather"
            ></vs-button>
  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: this.__('Subject'),
          field: 'real_subject',
          resizable: true,
        },
        {
          headerName: this.__('Causer'),
          field: 'real_causer',
          resizable: true,
        },
        {
