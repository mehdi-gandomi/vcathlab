<template>
  <div
    ...
    <div
      ...
      <menu-icon :icon="header.icon" svgClasses="h-5 w-5" class="mr-3" />
      <span class="whitespace-no-wrap">{{ __(header.i18n) || header.header }}</span>
      <menu-icon icon="ChevronDownIcon" svgClasses="h-4 w-4" class="ml-1" />
    </div>
