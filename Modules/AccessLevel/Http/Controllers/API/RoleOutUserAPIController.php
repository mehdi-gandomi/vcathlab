...
class RoleOutUserAPIController extends AppBaseController
{
    /** @var  UserRepository */
	...
	$role_user_ids = Role::find($request->get('role_id'))->getUsers(true);
        ...
        return $this->sendResponse(['pagination_data'=>['count'=>$usersCount,'total_pages'=>intval($usersCount/$limit)],'items'=>$users->toArray()], 'Users retrieved successfully');
    }
...
/**
    ...
    public function assign(Request $request)
    {
        ...
        foreach($ids as $user_id)
        		BaseUser::find($user_id)->assign($role_name);

        return $this->sendResponse(['count'=>count($ids)], 'Selected Users added to role');
    }
