...
mix.webpackConfig({
    output: {
        chunkFilename: 'vendor/place/js/chunks/[name].js'
    },
    resolve: {
        alias: {
...
mix.js(__dirname + '/Resources/js/app.js', 'vendor/place/js/app.js')
    .sass( __dirname + '/Resources/assets/sass/app.scss', 'vendor/place/css/app.css');
