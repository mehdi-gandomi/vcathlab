...
class AdministratorsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('\Modules\Ticket\Controllers\AdministratorsController@index');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('status', trans('ticket::lang.administrators-is-removed-from-team', ['name' => $administrator->name]));
