                    ...
                    <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ action('\Modules\Ticket\Controllers\DashboardController@index', 2) }}">
                                    {{ trans('ticket::admin.index-3-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Modules\Ticket\Controllers\DashboardController@index', 5) }}">
                                    {{ trans('ticket::admin.index-6-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Modules\Ticket\Controllers\DashboardController@index', 11) }}">
