<!DOCTYPE html>
<html  lang="{{ app()->getLocale() }}" dir="{{ in_array(app()->getLocale(), ['fa']) ? 'rtl' : 'ltr' }}" style="--vs-primary:115,103,240; --vs-success:40,199,111; --vs-danger:234,84,85; --vs-warning:241,196,15; --vs-dark:30,30,30; --vh:1.86px;">
   <head>
      <meta charset="UTF-8">
   ...
   <body class="theme-semi-dark" style="">
                                    ...
                                    <form method="POST" action="{{route('register')}}" class="clearfix">
                                        ...
                                        <div class="flex">
                                            <div class="flex-1 mx-1">
                                                <div class="vs-component vs-con-input-label vs-input w-full vs-input-primary mt-6">
                                                    <div class="vs-con-input">
                                                       <input type="text" name="first_name" placeholder="{{__('First name')}}" value="{{old('first_name',request('first_name'))}}" class="vs-inputx vs-input--input normal" style="border: 1px solid rgba(0, 0, 0, 0.2);">
                                                    </div>
                                                    @error('first_name')
                                                      <span>
                                            ...
                                            <div class="flex-1 mx-1">
                                                <div class="vs-component vs-con-input-label vs-input w-full vs-input-primary mt-6">
                                                    <div class="vs-con-input">
                                                       <input placeholder="{{__('Last name')}}" type="text" value="{{old('last_name',request('last_name'))}}" name="last_name" class="vs-inputx vs-input--input normal" style="border: 1px solid rgba(0, 0, 0, 0.2);">
                                                    </div>
                                                    @error('last_name')
                                                        <span>
                                                            <div class="con-text-validation span-text-validation-danger vs-input--text-validation-span">
                                       ...
                                       <div class="flex">
                                           ...
                                           <div class="flex-1 mx-1">
                                            <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                                <div class="vs-con-input">
                                                   <input placeholder="{{__('Cellphone')}}" type="tel" value="{{old('mobile')}}" name="mobile" class="vs-inputx vs-input--input normal hasValue" style="border: 1px solid rgba(0, 0, 0, 0.2);">
                                                </div>
                                                @error('mobile')
                                                  <span>
                                                      <div class="con-text-validation span-text-validation-danger vs-input--text-validation-span">
                                       ...
                                       <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                        <div class="vs-con-input">
                                           {{-- <input placeholder="{{__('Country')}}" type="text" value="{{old('country')}}" name="country" class="vs-inputx vs-input--input normal hasValue" style="border: 1px solid rgba(0, 0, 0, 0.2);"> --}}
                                     ...
                                     <div class="flex foreign-wrap">
                                         <div class="flex-1 mx-1">
                                            <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                                <div class="vs-con-input">
                                                   <input placeholder="{{__('State')}}" type="text" value="{{old('state')}}" name="state" class="vs-inputx vs-input--input normal hasValue" style="border: 1px solid rgba(0, 0, 0, 0.2);">
                                                </div>
                                                @error('state')
                                                  <span>
                                                      <div class="con-text-validation span-text-validation-danger vs-input--text-validation-span">
                                         ...
                                         <div class="flex-1 mx-1">
                                            <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                                <div class="vs-con-input">
                                                   <input placeholder="{{__('City')}}" type="text" value="{{old('city')}}" name="city" class="vs-inputx vs-input--input normal hasValue" style="border: 1px solid rgba(0, 0, 0, 0.2);">
                                                </div>
                                                @error('city')
                                                  <span>
                                                      <div class="con-text-validation span-text-validation-danger vs-input--text-validation-span">
                                     ...
                                     <div class="flex iran-wrap hidden">
                                        <div class="flex-1 mx-1">
                                           <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                               <div class="vs-con-input">
                                                  <label for="">{{__('Province')}}</label>
                                                  <select class="form-control" name="province_id" id="provinceSelect">
                                     ...
                                     <div class="flex">
                                        <div class="flex-1 mx-1">
                                            <div class="vs-component vs-con-input-label vs-input w-full mt-6 vs-input-primary ">
                                                <div class="vs-con-input">
                                                   {{-- <input placeholder="{{__('')}}" type="text" value="{{old('')}}" name="profession" class="vs-inputx vs-input--input normal hasValue" style="border: 1px solid rgba(0, 0, 0, 0.2);"> --}}
      ...
      <script src="/static/scripts/axios"></script>
      <script>
          function renderCities(cities){
            var output= cities.map(function(city){
                return "<option value='"+city.id+"'>"+city.en_name+"</option>";
            }).join(" ");
            document.getElementById("citySelect").innerHTML=output;
          }
          document.getElementById("countrySelect").addEventListener("input",function(e){
              if(e.target.value == "IR"){
                  document.querySelector(".foreign-wrap").classList.add("hidden");
                  document.querySelector(".iran-wrap").classList.remove("hidden");
              }
          })
          document.getElementById("provinceSelect").addEventListener("input",function(e){
                axios.get("/place/api/cities",{params:{province_id:e.target.value}})
                    .then(function(res){
