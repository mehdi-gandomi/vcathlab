                ...
                <vs-row vs-type="flex" vs-w="12" class="mb-6">
                    <vs-col vs-type="flex" vs-align="center" vs-lg="6">
                        <vs-row vs-type="flex" vs-w="12">
                            ...
                            <vs-col vs-type="flex" vs-align="center" vs-lg="9">
                                <component
                                    :is="inputs.Waist.type"
                                    v-model="form.Waist"
                                    class="w-full"
                                    :danger="hasValidationError('Waist')"
                                    :danger-text="validationError('Waist')"
                                    name="Waist"
                                    type="text"
                                />
                            </vs-col>
                        ...
                        <vs-row vs-type="flex" vs-w="12">
                            ...
                            <vs-col vs-type="flex" vs-align="center" vs-lg="9">
                                <component
                                    ...
                                    v-model="form.SMM"
                                    class="w-full"
                                    :danger="hasValidationError('SMM')"
                                    :danger-text="validationError('SMM')"
                                    name="SMM"
                                    type="text"
                                />
                            </vs-col>
                        ...
                        <vs-row vs-type="flex" vs-w="12">
                            ...
                            <vs-col vs-type="flex" vs-align="center" vs-lg="9">
                                <component
                                    ...
                                    v-model="form.VFP"
                                    class="w-full"
                                    :danger="hasValidationError('VFP')"
                                    :danger-text="validationError('VFP')"
                                    name="VFP"
                                    type="text"
                                />
                            </vs-col>
                        ...
                        <vs-row vs-type="flex" vs-w="12">
                            ...
                            <vs-col vs-type="flex" vs-align="center" vs-lg="9">
                                <component
                                    ...
                                    v-model="form.Hip"
                                    class="w-full"
                                    :danger="hasValidationError('Hip')"
                                    :danger-text="validationError('Hip')"
                                    name="Hip"
                                    type="text"
                                />
                            </vs-col>
                        ...
                        <vs-row vs-type="flex" vs-w="12">
                            ...
                            <vs-col vs-type="flex" vs-align="center" vs-lg="9">
                                <component
                                    ...
                                    v-model="form.BFMP"
                                    class="w-full"
                                    :danger="hasValidationError('BFMP')"
                                    :danger-text="validationError('BFMP')"
                                    name="BFMP"
                                    type="text"
                                />
                            </vs-col>
...
export default {
    ...
    methods: {
        async onSubmit(action) {
            const data = await this.form.post("/user/api/body_compositions");
            if (data.success) {
                Iracode.success(
                    this.__("Bodycomposition Created Successfully")
                );
                if (action == "close")
                    this.$router.push("/user/body_compositions");
