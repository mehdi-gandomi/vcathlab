<template>
 <vx-card class="example-full new-report" title="New FFR CT Case">
  ...
  <h5>
    ...
    <vs-row vs-type="flex" vs-w="12" class="my-6">
            <vs-col  vs-lg="12">
                <div class="flex justify-between items-center">
                    <label for="">{{__("Patient")}}</label>
                    <vs-button type="flat"  to="/user/patients/create">{{__("Add patient")}}</vs-button>
                </div>
                <vue-select class="w-full" :getOptionLabel="getPatientName" :reduce="op=>op.id" v-model="data.patient_id" :options="patients"></vue-select>
            </vs-col>
    </vs-row>
