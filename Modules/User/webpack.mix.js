...
mix.webpackConfig({
    output: {
        chunkFilename: 'vendor/user/js/chunks/[name].js'
    },
    resolve: {
        alias: {
...
mix.js(__dirname + '/Resources/js/app.js', 'vendor/user/js/app.js')
    .sass( __dirname + '/Resources/assets/sass/app.scss', 'vendor/user/css/app.css');
