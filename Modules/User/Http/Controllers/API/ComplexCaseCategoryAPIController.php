...
use Modules\User\Http\Requests\API\CreateComplexCaseCategoryAPIRequest;
use Modules\User\Http\Requests\API\UpdateComplexCaseCategoryAPIRequest;
use Modules\User\Models\ComplexCaseCategory;
use Modules\User\Repositories\ComplexCaseCategoryRepository;
