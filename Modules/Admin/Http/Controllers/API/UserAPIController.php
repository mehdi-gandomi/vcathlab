...
use Modules\Admin\Http\Requests\API\CreateUserAPIRequest;
use Modules\Admin\Http\Requests\API\UpdateUserAPIRequest;
...
class UserAPIController extends AppBaseController
{
    ...
    {
        $input = $request->all();
        $input['city_id']=isset($input['city_id']) && $input['city_id'] ? $input['city_id']:1;
        $input['province_id']=isset($input['province_id']) && $input['province_id'] ? $input['province_id']:1;
        $input['country']=isset($input['country']) && $input['country'] ? $input['country']:1;
