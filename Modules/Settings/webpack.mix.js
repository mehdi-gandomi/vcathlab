...
mix.webpackConfig({
    output: {
        chunkFilename: 'vendor/settings/js/chunks/[name].js'
    },
    resolve: {
        alias: {
...
mix.js(__dirname + '/Resources/js/app.js', 'vendor/settings/js/app.js')
    // .sass( __dirname + '/Resources/assets/sass/app.scss', 'vendor/settings/css/app.css');
